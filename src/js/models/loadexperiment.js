function loadEXPERIMENT(){
    ...
    head_left = new Block(origin = [4.25,18.5,-11.75],15,8,7.5, obj_name = "LeftHead"  )
    head_mid = new Block(origin = [4.25,18.5,-3.75], 15,8,7.5, obj_name = "MiddleHead" )
    head_right = new Block(origin =  [4.25,18.5,4.25], 15,8,7.5, obj_name = "RightHead" )

    wing_left_mid = new Block(origin = [-15.5,14.75,-12.5],15,0.75,-9, obj_name = "LeftMainWing" )
    ...
    leg_right = new Block(origin = [-12.5,9,14.5],10,-18,-7, obj_name = "RightLeg" )

    tail_1 = new Block(origin = [-20,9,-10]   ,-8,  5.5, 20, obj_name = "Tail1" )
    tail_2 = new Block(origin = [-28,8.75,-8] ,-7,  5,   16, obj_name = "Tail2" )
    tail_3 = new Block(origin = [-35,8.5,-6.5]  ,-6,  4.5, 13, obj_name = "Tail3" )
    tail_4 = new Block(origin = [-41,8.25,-5.5]  ,-5,  4,   11, obj_name = "Tail4" )
    tail_5 = new Block(origin = [-46,8.5,-6.5]  ,-6,  4.5, 13, obj_name = "Tail5" )
    tail_6 = new Block(origin = [-52,8.25,-2.5]  ,-5,  4,   5, obj_name = "Tail6" )
