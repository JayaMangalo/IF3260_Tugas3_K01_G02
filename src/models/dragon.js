function loadDragon() {
  ...
  head_mid = new Block(
    (origin = [4.25, 18.5, -3.75]),
    15,
    6,
    7.5,
    (obj_name = "MiddleHead")
  );
  head_right = new Block(
    (origin = [4.25, 18.5, 4.25]),
    15,
    6,
    7.5,
    (obj_name = "RightHead")
  ...
  fireball_left_1 = new Block(
    (origin = [9.25 - 0.1, 20.5 - 0.1, -8.5 - 0.1]),
    1.2,
    1.2,
    1.2,
    (obj_name = "LeftFireball1")
  );
  fireball_left_2 = new Block(
    (origin = [9.25 - 0.05, 20.5 - 0.05, -8.5 - 0.05]),
    1.1,
    1.1,
    1.1,
    (obj_name = "LeftFireball2")
  );
  fireball_left_3 = new Block(
    (origin = [9.25, 20.5, -8.5]),
    1,
    1,
    1,
    (obj_name = "LeftFireball3")
  );

  fireball_mid_1 = new Block(
    (origin = [9.25 - 0.1, 20.5 - 0.1, -0.5 - 0.1]),
    1.2,
    1.2,
    1.2,
    (obj_name = "MiddleFireball1")
  );
  fireball_mid_2 = new Block(
    (origin = [9.25 - 0.05, 20.5 - 0.05, -0.5 - 0.05]),
    1.1,
    1.1,
    1.1,
    (obj_name = "MiddleFireball3")
  );
  fireball_mid_3 = new Block(
    (origin = [9.25, 20.5, -0.5]),
    1,
    1,
    1,
    (obj_name = "MiddleFireball2")
  );

  fireball_right_1 = new Block(
    (origin = [9.25 - 0.1, 20.5 - 0.1, 7.5 - 0.1]),
    1.2,
    1.2,
    1.2,
    (obj_name = "RightFireball1")
  );
  fireball_right_2 = new Block(
    (origin = [9.25 - 0.05, 20.5 - 0.05, 7.5 - 0.05]),
    1.1,
    1.1,
    1.1,
    (obj_name = "RightFireball2")
  );
  fireball_right_3 = new Block(
    (origin = [9.25, 20.5, 7.5]),
    1,
    1,
    1,
    (obj_name = "RightFireball3")
  );

  wing_left_mid = new Block(
    (origin = [-15.5, 14.75, -21.5]),
    15,
    0.75,
    9,
    (obj_name = "LeftMainWing")
  );

  wing_right_mid = new Block(
    (origin = [-15.5, 14.75, 12.5]),
    15,
    0.75,
    9,
    (obj_name = "RightMainWing")
  );
